...
const persBases = [
    ...
    { i: 'MILD', b: "You're basically playing financial chicken every month." },
    { i: 'MILD', b: "You look at your {b} balance and just accept that math is an illusion." },
    { i: 'SAVAGE', b: "You manage money like a toddler managing a casino." },
    { i: 'SAVAGE', b: "If your {b} was a person, it would file a restraining order." },
    { i: 'SAVAGE', b: "Your spending history looks like an unmedicated manic episode." },
    { i: 'SAVAGE', b: "You buy things you don't need purely to feel something." },
    { i: 'BRUTAL', b: "You are a weapon of mass financial destruction." },
    { i: 'BRUTAL', b: "Your financial statements should come with a trigger warning." },
    { i: 'BRUTAL', b: "I'd ask you to invest in your future but you think 3 days from now is long-term." }
];
...
const foodBases = [
    ...
    { i: 'MILD', b: "Your kitchen is basically just a storage unit for leftover {f} boxes." },
    { i: 'SAVAGE', b: "At this point, {f} is probably classifying you as an angel investor." },
    { i: 'SAVAGE', b: "You claim you're broke but your {f} history says you eat like royalty." },
    { i: 'SAVAGE', b: "You spend more on {c} delivery fees than actual healthcare." },
    { i: 'BRUTAL', b: "Your food delivery stats are starting to look like a restaurant's annual revenue." },
...
const regionBases = [
    ...
    { reg: 'IN', i: 'BRUTAL', b: "You buy things on EMI with the confidence of someone immortal." },
    { reg: 'US', i: 'MILD', b: "You spend more on {t} and iced coffee than you do on self-improvement." },
    { reg: 'US', i: 'SAVAGE', b: "You are one missed paycheck away from becoming a cautionary tale." },
    { reg: 'GB', i: 'SAVAGE', b: "Your financial situation is bleaker than the London weather." },
    { reg: 'SEA', i: 'MILD', b: "You complain about being broke but somehow always afford {f}." },
    { reg: 'SEA', i: 'SAVAGE', b: "You claim you're broke but your {f} history says you eat like royalty." },
    { reg: 'EA', i: 'SAVAGE', b: "You live in a tiny apartment but fund an empire inside the nearest {c}." },
    { reg: 'LATAM', i: 'BRUTAL', b: "You use {b} installments (cuotas) like they are a human right." },
    { reg: 'ANZ', i: 'BRUTAL', b: "You complain about housing prices but spend {m40} a day on {f}." },
